<?php
  ...
  class search extends room{
      ...
      function __construct($permission = false){
           ...
           unset($config);
           search::action_search();                                          //Обрабатываем действие пользоватей.
      ...
      private function action_search(){
          
          
          $this->heat = 'Информационно-поисковая система!';
          
          
          
          
          
          room::outContent(search::getView());                            //Вывод всего модуля.
      }
