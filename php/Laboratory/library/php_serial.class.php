 ...
 *
 * @author Rйmy Sanchez <thenux@gmail.com>
 * @thanks Aurйlien Derouineau for finding how to open serial ports with windows
    ...
    public function deviceSet ($device)
    {
        if ($this->_dState !== SERIAL_DEVICE_OPENED) {
            if ($this->_os === "linux") {
                ...
                //if (preg_match("@^COM(\d+):?$@i", $device, $matches) and $this->_exec(exec("mode " . $device . "xon=on BAUD=38400")) === 0) {
